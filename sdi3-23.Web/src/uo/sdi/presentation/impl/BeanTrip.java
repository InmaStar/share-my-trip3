...
public class BeanTrip implements Serializable {
	...
	try {
	    viaje = BusinessFactories.services.getTripService().update(viaje);
	...
	try {
	    ...
	    viaje = BusinessFactories.services.getTripService().insert(viaje,
		    promotor);
	...
	try {
	    ...
	    viaje = BusinessFactories.services.getTripService()
		    .confirmApplication(userId, viaje);
	    return "exito";
	} catch (Exception e) {
	...
	try {
	    ...
	    viaje = BusinessFactories.services.getTripService().cancelSeat(
		    user.getId(), viaje);
	    return "exito";
	} catch (Exception e) {
