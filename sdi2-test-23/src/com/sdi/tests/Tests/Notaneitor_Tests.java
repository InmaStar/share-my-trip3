...
public class Notaneitor_Tests {
	...
	public void testAltaParametros(String nombreform, String nombre,
			String apellidos, String iduser, String email) {
		// Pinchamos la opción de menu Alta Alumno
		SeleniumUtils.ClickSubopcionMenuHover(driver,
				"form-cabecera:misubmenu1", "form-cabecera:linkalta");
		...
		new PO_AltaForm().rellenaFormulario(driver, nombre, apellidos, iduser,
				email);
	...
	public void testAlta() {
		...
		testAltaParametros("Alta de un alumno", "manolo1", "Suarez1",
				"idmano1", "manolo1@correo.com");
	}
	...
	public void testListado() {
		...
		SeleniumUtils.ClickSubopcionMenuHover(driver,
				"form-cabecera:misubmenu1", "form-cabecera:linklistado");
	...
	// //td[contains(text(),
	// 'idpepe@correo.com')]/following-sibling::*/a[contains(@id, 'bajalink')]")
	// td[contains(text(),
	// 'idpepe@correo.com')]/following-sibling::*/a[contains(@id, 'editlink')]")

	@Test
	public void testBaja() throws InterruptedException {
		// Insertamos un alumno de prueba y llegamos hasta ver el listado
		// con el alumno
		testAltaParametros("Alta de un alumno", "manolo2", "Suarez2",
				"idmano2", "manolo2@correo.com");

		// Vamos a borrar el alumno insertado
		// Pinchamos el enlace de baja de manolo
		By enlace = By
				.xpath("//td[contains(text(), 'manolo2@correo.com')]/following-sibling::*/a[contains(@id, 'bajalink')]");
	...
	public void testEdit() throws InterruptedException {
		// Insertamos un alumno de prueba y llegamos hasta ver el listado
		// con el alumno
		testAltaParametros("Alta de un alumno", "manolo3", "Suarez3",
				"idmano3", "manolo3@correo.com");

		// Vamos a editar el alumno insertado
		// Pinchamos el enlace de edicion de manolo
		By enlace = By
				.xpath("//td[contains(text(), 'manolo3@correo.com')]/following-sibling::*/a[contains(@id, 'editlink')]");
		driver.findElement(enlace).click();

		// Esperamos a que se cargue la pagina de alta de alumno
		SeleniumUtils.EsperaCargaPagina(driver, "text", "Edición de un alumno",
				10);

		// Vamos a rellenar el formulario
		new PO_AltaForm().rellenaFormulario(driver, "manolo3", "Suarez3 modif",
				"idmano3", "manolomodif@correo.com");
